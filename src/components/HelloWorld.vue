<template>
  <div class="prose max-w-none">
    ...
    <p>
      View this project on <a href="https://github.com/vincentdoerig/vue3-typescript-tailwind-starter">GitHub</a>. It uses <a href="https://github.com/vitejs/vite">vite</a> to provide a fast development experience with hot module replacement. Try it out by editing <code>components/HelloWorld.vue</code>.
    </p>
    <p>
...
git init <span class="text-gray-500"># initialise git for your new project</span></pre>
    <p>
      Alternatively, use this starter by clicking the <code>Use this template</code> button on <a href="https://github.com/vincentdoerig/vue3-typescript-tailwind-starter">GitHub</a>.
    </p>
